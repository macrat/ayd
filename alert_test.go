...
func TestAlert(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.TargetIn, func(t *testing.T) {
			alert, err := main.NewAlert(tt.TargetIn)
			if err != nil {
	...
	t.Run("broken:", func(t *testing.T) {
		alert, err := main.NewAlert("broken:")
		if err != nil {
			t.Fatalf("unexpected error: %s", err)
		}
...
func TestReplaceReporter(t *testing.T) {
	...
	r2 := main.ReplaceReporter{&url.URL{Scheme: "alert", Opaque: "dummy:hello-world"}, r1}
